...
public extension PPView {
     ...
     */
    @discardableResult
    public func set(_ edge: PPAttribute, of value: CGFloat, relation: PPRelation = .equal, ratio: CGFloat = 1.0, priority: PPPriority = .required) -> NSLayoutConstraint {
    ...
    /**
     ...
     - parameter priority: Constraint's priority (default is *.required*).
     - returns: The applied constraints in PPMultipleConstraints - see definition (discardable).
     */
    @discardableResult
    public func set(_ edges: PPAttribute..., of value: CGFloat, relation: PPRelation = .equal, ratio: CGFloat = 1.0, priority: PPPriority = .required) -> PPMultipleConstraints {
    ...
    @discardableResult
    func set(_ edges: [PPAttribute], to value: CGFloat, relation: PPRelation = .equal, ratio: CGFloat = 1.0, priority: PPPriority = .required) -> PPMultipleConstraints {
        var constraints: PPMultipleConstraints = [:]
     ...
     */
    @discardableResult
    public func layout(_ edge: PPAttribute? = nil, to otherEdge: PPAttribute, of view: PPView, relation: PPRelation = .equal, ratio: CGFloat = 1.0, offset: CGFloat = 0, priority: PPPriority = .required) -> NSLayoutConstraint? {
        guard isValidForPapaLayout else {
     ...
     */
    @discardableResult
    public func layout(_ edges: PPAttribute..., to view: PPView, relation: PPRelation = .equal, ratio: CGFloat = 1.0, offset: CGFloat = 0, priority: PPPriority = .required) -> PPMultipleConstraints {
        var constraints: PPMultipleConstraints = [:]
        guard isValidForPapaLayout else {
            print("\(String(describing: self)) Error in func: \(#function)")
            return constraints
     ...
     */
    @discardableResult
    public func layoutToSuperview(_ edge: PPAttribute, relation: PPRelation = .equal, ratio: CGFloat = 1, offset: CGFloat = 0, priority: PPPriority = .required) -> NSLayoutConstraint? {
        guard isValidForPapaLayout else {
            print("\(String(describing: self)) Error in func: \(#function)")
            return nil
        }
    ...
    /**
     ...
     - parameter priority: Constraints' priority (default is *.required*).
     - returns: The instance of PPMultipleConstraints - see type definition (discardable).
     */
    @discardableResult
    public func layoutToSuperview(_ edges: PPAttribute..., relation: PPRelation = .equal, ratio: CGFloat = 1, offset: CGFloat = 0, priority: PPPriority = .required) -> PPMultipleConstraints {
        var constraints: PPMultipleConstraints = [:]
        guard !edges.isEmpty && isValidForPapaLayout else {
            return constraints
        }
        let uniqueEdges = Set(edges)
        for edge in uniqueEdges {
     ...
     */
    @discardableResult
    public func layoutToSuperview(axis: PPAxis, offset: CGFloat = 0, priority: PPPriority = .required) -> PPAxisConstraints? {
        ...
        return PPAxisConstraints(first: first, second: second)
    }
    ...
    /**
     ...
     - parameter priority: Represents constraint's priority (default is *.required*)
     - returns: The instance of PPSizeConstraints - see definition (discardable).
     */
    @discardableResult
    public func sizeToSuperview(withRatio ratio: CGFloat = 1, offset: CGFloat = 0, priority: PPPriority = .required) -> PPSizeConstraints? {
        let size = layoutToSuperview(.width, .height, ratio: ratio, offset: offset, priority: priority)
        guard !size.isEmpty else {
            return nil
        }
        return PPSizeConstraints(width: size[.width]!, height: size[.height]!)
    }
    ...
    /**
     ...
     - parameter priority: Represents constraint's priority (default is *.required*)
     - returns: The instance of PPCenterConstraints - see definition (discardable).
     */
    @discardableResult
    public func centerInSuperview(offset: CGFloat = 0, priority: PPPriority = .required) -> PPCenterConstraints? {
        let center = layoutToSuperview(.centerX, .centerY, offset: offset)
        guard !center.isEmpty else {
            return nil
        }
        return PPCenterConstraints(x: center[.centerX]!, y: center[.centerY]!)
    }
    ...
    /**
     ...
     - parameter priority: Represents constraint's priority (default is *.required*)
     - returns: The instance of PPFillConstraints - see definition (discardable).
     */
    @discardableResult
    public func fillSuperview(withSizeRatio ratio: CGFloat = 1, offset: CGFloat = 0, priority: PPPriority = .required) -> PPFillConstraints? {
        ...
        return PPFillConstraints(center: center, size: size)
    }
    
    /** **PRIVATELY USED** to test for validation*/
    var isValidForPapaLayout: Bool {
